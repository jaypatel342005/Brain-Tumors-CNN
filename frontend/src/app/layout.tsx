...
export const metadata: Metadata = {
  ...
  description: 'NeuralScan.AI uses a fine-tuned EfficientNet-V2-S deep learning model (~21M parameters) to classify brain MRI scans into 4 categories: Glioma, Meningioma, Pituitary Tumor, and No Tumor — with 95.75% test accuracy.',
  keywords: [
    ...
    'transfer learning', 'Mixup augmentation', 'Fused-MBConv',
  ],
