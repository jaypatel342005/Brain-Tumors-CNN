...
export const metadata: Metadata = {
  ...
  description: 'Upload a brain MRI scan and get instant AI-powered classification. Our fine-tuned EfficientNet-V2-S model detects Glioma, Meningioma, Pituitary Tumor, and No Tumor with high accuracy.',
  openGraph: {
