  ...
  return (
    ...
    >
      {stats.map((stat, i) => (
        <div
          key={i}
          className="relative group text-center py-6 px-4 rounded-2xl bg-slate-900/40 border border-white/5 hover:border-cyan-500/20 transition-all duration-500 hover:bg-slate-900/60"
        >
